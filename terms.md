...
By buying and using our products, you agree to follow these terms. 
...
These terms apply to all products manufactured by Whitehill Group and it's subsidiaries.

=== Unauthorized Access and Modification

You agree not to bypass, interfere with, or attempt to circumvent the licensing systems implemented in our products.
You also agree not to modify, alter, or tamper with any engine scripts without explicit authorization.
