...
You are free to move, rotate and scale your door, cabinet, and reader models to your liking, Net2+ comes with 2 industrial and 3 office doors as a showcase.

!!!warning
We don't recommend modifying the cabinet and reader models, unless you know what you're doing. **Proceed at your own risk.**
!!!
===

=== 3. Configure your Net2+.
Net2+ was designed to work out of the box, but for the best experience we recommend customizing the per-door config.

!!!info
For more information check out the [Configuration](/dwpnet2/configuration.md) page.
!!!
===
